...
# Labels have length limits — abbreviations expand to full org names here.
...
if __name__ == "__main__":
    ...
    run_generate_config(token, TEAM_SETTINGS, long_org_name_mapping=LONG_ORG_NAME_MAPPING)
